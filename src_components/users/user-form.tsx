  ...
  useEffect(() => {
    if (isOpen) {
      if (user) {
        form.reset({
            ...user,
            fechaCreacion: user.fechaCreacion ? new Date(user.fechaCreacion as any) : new Date(),
            fechaCulminacionContrato: user.fechaCulminacionContrato ? new Date(user.fechaCulminacionContrato as any) : undefined,
        });
      } else {
        form.reset({
          nombre: '',
