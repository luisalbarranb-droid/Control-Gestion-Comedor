...
export const users: User[] = [
  ...
  },
  {
    ...
    area: 'cocina',
    activo: true,
    fechaCreacion: new Date('2023-04-10'),
...
export const tasks: Task[] = [
  {
    ...
    fechaCreacion: new Date(new Date().setDate(new Date().getDate() - 2)),
  ...
  },
  {
    ...
    fechaCreacion: new Date(new Date().setDate(new Date().getDate() - 1)),
    fechaVencimiento: new Date(new Date().setDate(new Date().getDate() + 10)),
    tiempoEstimado: 120,
    checklist: [],
    evidencias: [],
    comentarios: [],
  ...
  },
  {
    ...
    fechaCompletado: new Date(new Date().setDate(new Date().getDate() - 1)),
    tiempoEstimado: 180,
    checklist: [],
    evidencias: [],
    comentarios: [],
    ...
    fechaCreacion: new Date(new Date().setDate(new Date().getDate() - 5)),
