  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* This is what shows the sidebar. */}
        <div
          className={cn(
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn("flex flex-row items-center gap-2 rounded-md px-2 py-1.5", className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
          className="size-4 rounded-md"
          data-sidebar="skeleton-icon"
        />
      )}
      <Skeleton
