...
// ELIMINADOS: Sidebar, Header, MainNav (Causaban duplicidad)
import { Users, ClipboardCheck, Clock, TrendingUp, Calendar as CalendarIcon } from 'lucide-react';
...
export default function StatsPage() {
  ...
  // ESTRUCTURA LIMPIA: Solo el contenido principal
  return (
