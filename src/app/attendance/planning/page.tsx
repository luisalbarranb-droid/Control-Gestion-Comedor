...
import { useCollection, useFirestore, useMemoFirebase, addDocumentNonBlocking, deleteDocumentNonBlocking, commitBatchNonBlocking } from '@/firebase';
    ...
    try {
      ...
      Object.entries(selectedDays).forEach(([userId, dates]) => {
        dates.forEach(dateStr => {
          const newDocRef = doc(dayOffCollection);
          batch.set(newDocRef, {
            userId: userId,
            date: dateStr,
