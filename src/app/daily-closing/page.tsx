...
export default function DailyClosingPage() {
  ...
  const { data: todayMenus, isLoading: isLoadingMenu } = useCollection<Menu>(menuQuery);

  const todayPlannedMenu = useMemo(() => {
    if (!todayMenus || todayMenus.length === 0) return null;
    // Prioritize 'almuerzo' if multiple menus exist for today
        ...
        <Card className="border-l-4 border-l-blue-500 shadow-sm">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              De 150 planificadas (96% de ejecución)
            </p>
          </CardContent>
        </Card>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {cierre.comidas} platos servidos
                      </p>
                    </div>
                  </div>
